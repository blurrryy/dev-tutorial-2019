...
{% hint style="info" %}
Wir werden uns den Technologien des folgenden Videos dann nähern, wenn sie benötigt werden.
{% endhint %}
...
JavaScript ist in der heutigen Webentwicklung eine der wichtigsten Sprachen, die man lernen kann. Grundsätzlich kann im Jahr 2019 nahezu Alles \(inklusive Desktop-Apps, nativen Mobile-Apps, Computerspielen etc.\) mit JavaScript realisiert werden.
